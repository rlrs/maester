# Parallelization for GLM4 MoE models
...
def parallelize_glm4(
    ...
    parallelism to the GLM4 MoE model.
    """
...
def apply_tp(
    ...
    """Apply tensor parallelism to GLM4 MoE model."""
    ...
    for layer_id, layer in enumerate(model.model.layers):
        ...
        # GLM4 MoE uses qkv_proj instead of separate wq, wk, wv
        parallelize_module(
