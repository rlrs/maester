...
class GroupedExperts(nn.Module):
    ...
    def forward(
        ...
        if self.use_grouped_mm:
            return self._run_experts_grouped_mm(
...
class TokenChoiceTopKRouter(nn.Module):
    ...
    def __init__(
        ...
        route_scaling_factor: float = 1.0,
    ):
        super().__init__()
        ...
        self.route_scaling_factor = route_scaling_factor
    ...
    def forward(
        ...
        top_scores = (
            top_scores * self.route_scaling_factor
...
class MoE(nn.Module):
    def __init__(self, model_args: DeepSeekModelArgs):
        ...
        self.router = TokenChoiceTopKRouter(
            ...
            route_scaling_factor=route_scaling_factor,
        )
        self.shared_expert = (
