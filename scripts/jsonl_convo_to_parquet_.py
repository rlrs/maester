...
def convert_jsonl_to_parquet(input_path: str, output_path: str, row_group_size: int = 50000):
    """
...
def main():
    ...
    convert_jsonl_to_parquet(args.input, args.output, args.row_group_size)
